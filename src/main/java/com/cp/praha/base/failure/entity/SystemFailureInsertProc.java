...
import static com.cp.praha.base.failure.entity.SystemFailureInsertProc.PROC_NAME;
...
@NamedStoredProcedureQuery(
        ...
        parameters = {
                ...
                @StoredProcedureParameter(
                        name = "O_SYSTEM_FAILURE_ID", type = Integer.class, mode = ParameterMode.OUT
                ),
                @StoredProcedureParameter(
...
public class SystemFailureInsertProc {
    public static final String PROC_NAME = "USP_SYSTEM_FAILURE_INS";

    @Id
    private String systemFailureUuid;

    public static StoredProcedureQuery procedureQuery(EntityManager entityManager, SystemFailureInsertCommand command) {
