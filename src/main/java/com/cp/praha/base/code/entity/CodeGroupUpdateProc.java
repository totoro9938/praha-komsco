...
import com.cp.praha.base.code.service.request.CodeGroupUpdateCommand;
...
import static com.cp.praha.base.code.entity.CodeGroupUpdateProc.PROC_NAME;
...
@Entity
public class CodeGroupUpdateProc {
    public static final String PROC_NAME = "USP_CODE_GROUP_UPT";

    @Id
    private String codeGroupCd;

    public static StoredProcedureQuery procedureQuery(EntityManager entityManager,CodeGroupUpdateCommand command) {
