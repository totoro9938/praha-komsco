...
import com.cp.praha.base.logInfo.service.request.LogInfoAclSelectPageCommand;
import com.cp.praha.base.logInfo.service.response.LogInfoAclSelectPageDomain;
...
import static com.cp.praha.base.logInfo.entity.LogInfoAclSelectPageProc.PROC_NAME;

@NamedStoredProcedureQuery(
        name = PROC_NAME,
        procedureName = PROC_NAME,
        resultClasses = LogInfoAclSelectPageDomain.class,
        parameters = {
...
@Entity
public class LogInfoAclSelectPageProc {
    public static final String PROC_NAME = "USP_LOG_ACL_SEL_PAGE";

    @Id
    private Integer aclLogIdx;

    public static StoredProcedureQuery procedureQuery(EntityManager entityManager,
                                                      LogInfoAclSelectPageCommand command) {
