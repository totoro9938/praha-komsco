...
import com.cp.praha.base.logInfo.service.request.LogInfoLoginSelectCommand;
import com.cp.praha.base.logInfo.service.response.LogInfoLoginSelectDomain;
...
import static com.cp.praha.base.logInfo.entity.LogInfoLoginSelectProc.PROC_NAME;

@NamedStoredProcedureQuery(
        name = PROC_NAME,
        procedureName = PROC_NAME,
        resultClasses = LogInfoLoginSelectDomain.class,
        parameters = {
...
@Entity
public class LogInfoLoginSelectProc {
    public static final String PROC_NAME = "USP_LOG_LOGIN_SEL_PAGE";

    @Id
    private Integer userId;

    public static StoredProcedureQuery procedureQuery(EntityManager entityManager,
                                                      LogInfoLoginSelectCommand command) {
