...
import com.cp.praha.base.program.service.request.ProgramInsertCommand;
...
import static com.cp.praha.base.program.entity.ProgramInsertProc.PROC_NAME;
...
@NamedStoredProcedureQuery(
        ...
        parameters = {
                ...
                @StoredProcedureParameter(
                        name = "V_PROGRAM_ID", type = Integer.class, mode = ParameterMode.OUT
                ),
                @StoredProcedureParameter(
...
@Entity
public class ProgramInsertProc {
    public static final String PROC_NAME = "USP_PROGRAM_INS";

    @Id
    private Integer programId;

    public static StoredProcedureQuery procedureQuery(EntityManager entityManager,
                                                      ProgramInsertCommand command) {
        var procedureQuery = ProcedureQuery.get(entityManager, PROC_NAME);
        procedureQuery.setParameter("V_PARENT_ID", command.getParentId());
        procedureQuery.setParameter("V_PROGRAM_UUID", command.getProgramUuid());
