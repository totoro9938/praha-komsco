...
import static com.cp.praha.base.department.entity.DepartmentUpdateProc.PROC_NAME;
...
@Entity
public class DepartmentUpdateProc {
    public static final String PROC_NAME = "USP_DEPT_UPT";

    @Id
    private Integer deptId;

    public static StoredProcedureQuery procedureQuery(EntityManager entityManager,DepartmentUpdateCommand command) {
