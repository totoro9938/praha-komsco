package com.cp.praha.knowledge.manualcallclass.service;

import com.cp.praha.common.domain.GridDomain;
import com.cp.praha.common.util.GenericListType;
import com.cp.praha.common.util.ProcErrorHandler;
import com.cp.praha.knowledge.manualcallclass.entity.ManualCallClassSelPageProc;
...
public class ManualCallClassService {
    private final EntityManager entityManager;

    public GridDomain manualCallClassSelPage(ManualCallClassSelPageCommand command){

        var procedure = ManualCallClassSelPageProc.procedureQuery(entityManager,command);
