...
import com.cp.praha.work.campaign.service.request.CampaignCustDisInsertCommand;
...
import static com.cp.praha.work.campaign.entity.CampaignCustUpdateDisInsertProc.PROC_NAME;
...
@Entity
public class CampaignCustUpdateDisInsertProc {
    public static final String PROC_NAME = "USP_CAMPAIGN_CUST_UPT_DIS_INS";

    @Id
    private String campaignId;

    public static StoredProcedureQuery procedureQuery(EntityManager entityManager,
                                                      CampaignCustDisInsertCommand command) {
