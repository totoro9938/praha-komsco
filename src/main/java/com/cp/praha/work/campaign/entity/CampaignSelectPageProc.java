...
import com.cp.praha.work.campaign.service.request.CampaignSelectPageCommand;
import com.cp.praha.work.campaign.service.response.CampaignSelectPageDomain;
...
import static com.cp.praha.work.campaign.entity.CampaignSelectPageProc.PROC_NAME;

@NamedStoredProcedureQuery(
        name = PROC_NAME,
        procedureName = PROC_NAME,
        resultClasses = CampaignSelectPageDomain.class,
        parameters = {
...
@Entity
public class CampaignSelectPageProc {
    public static final String PROC_NAME = "USP_CAMPAIGN_SEL_PAGE";

    @Id
    private Integer userId;

    public static StoredProcedureQuery procedureQuery(EntityManager entityManager,
                                                      CampaignSelectPageCommand command) {
