...
import static com.cp.praha.work.area.entity.AreaUpdateProc.PROC_NAME;
...
@Entity
public class AreaUpdateProc {
    public static final String PROC_NAME = "USP_AREA_UPT";
    @Id
    private int areaId;

    public static StoredProcedureQuery procedureQuery(EntityManager entityManager, AreaUpdateCommand command){
