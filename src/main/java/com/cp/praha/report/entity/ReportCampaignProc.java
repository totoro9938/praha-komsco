...
import com.cp.praha.report.service.request.ReportCampaignCommand;
import com.cp.praha.report.service.response.ReportCampaignDomain;
...
@NamedStoredProcedureQuery(
        name = ReportCampaignProc.PROC_NAME,
        procedureName = ReportCampaignProc.PROC_NAME,
        resultClasses = ReportCampaignDomain.class,
        parameters = {
...
@Entity
public class ReportCampaignProc {
    public static final String PROC_NAME = "USP_REPORT_CAMPAIGN";

    @Id
    private String id;

    public static StoredProcedureQuery procedureQuery(EntityManager entityManager,ReportCampaignCommand command) {
