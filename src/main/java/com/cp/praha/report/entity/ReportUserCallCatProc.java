...
import com.cp.praha.report.service.response.ReportUserCallCatDomain;
...
@NamedStoredProcedureQuery(
        name = ReportUserCallCatProc.PROC_NAME,
        procedureName = ReportUserCallCatProc.PROC_NAME,
        resultClasses = ReportUserCallCatDomain.class,
        parameters = {
...
@Entity
public class ReportUserCallCatProc {
    public static final String PROC_NAME = "USP_REPORT_USER_CALL_CAT";
