...
import com.cp.praha.report.service.request.ReportTransferListCommand;
import com.cp.praha.report.service.response.ReportTransferListDomain;
...
@NamedStoredProcedureQuery(
        name = ReportTransferListProc.PROC_NAME,
        procedureName = ReportTransferListProc.PROC_NAME,
        resultClasses = ReportTransferListDomain.class,
        parameters = {
...
@Entity
public class ReportTransferListProc {
    public static final String PROC_NAME = "USP_REPORT_TRANSFER";

    @Id
    private String id;

    public static StoredProcedureQuery procedureQuery(EntityManager entityManager, ReportTransferListCommand command) {
