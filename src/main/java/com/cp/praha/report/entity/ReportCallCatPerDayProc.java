...
import com.cp.praha.report.service.request.ReportCallCatPerDayCommand;
import com.cp.praha.report.service.response.ReportCallCatPerDayDomain;
...
@NamedStoredProcedureQuery(
        name = ReportCallCatPerDayProc.PROC_NAME,
        procedureName = ReportCallCatPerDayProc.PROC_NAME,
        resultClasses = ReportCallCatPerDayDomain.class,
        parameters = {
...
@Entity
public class ReportCallCatPerDayProc {
    public static final String PROC_NAME = "USP_REPORT_CALL_CAT_PER_DAY";

    @Id
    private String id;

    public static StoredProcedureQuery procedureQuery(EntityManager entityManager, ReportCallCatPerDayCommand command) {
