...
import com.cp.praha.report.service.response.DiscomfortReportDeptDomain;
...
@NamedStoredProcedureQuery(
        name = DiscomfortReportDeptProc.PROC_NAME,
        procedureName = DiscomfortReportDeptProc.PROC_NAME,
        resultClasses = DiscomfortReportDeptDomain.class,
        parameters = {
...
@Entity
public class DiscomfortReportDeptProc {
    public static final String PROC_NAME = "USP_DISCOMFORT_REPORT_DEPT";
